           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a href="index.php?halaman=driver"><i class="fa fa-dashboard fa-3x"></i> Driver</a>
                    </li>
                </ul>
            ...
            <div id="page-inner">
               <?php
                    if(isset($_GET['halaman']))
                    {
                        ...
                        elseif ($_GET['halaman']=="hapusdriver")
                        {
                            include 'hapusdriver.php';
                        }                        
